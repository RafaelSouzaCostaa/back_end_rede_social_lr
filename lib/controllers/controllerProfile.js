...
module.exports = {
    ...
    getAll: async function (req, res, next) {
        ...
        /*
            #swagger.tags = ['Profile']
            #swagger.summary = 'Buscando todos os perfis'
            #swagger.responses[404] = {
    ...
    getByNickname: async function (req, res, next) {
        /*  
            #swagger.tags = ['Profile']
            #swagger.summary = 'Buscando perfil por nickname'
    ...
    getById: async function (req, res, next) {
        /*  
            #swagger.tags = ['Profile']
            #swagger.summary = 'Buscando perfil por ID'
        */
    ...
    deleteByID: async function (req, res, next) {
        /**
         * #swagger.tags = ['Profile']
         #swagger.summary = 'Deletar perfil por ID'
         #swagger.responses[404] = {
                description: "Perfil não encontrado!",
            }
         */
        try {
            ...
            if(profile){
                await Profile.findOneAndDelete({_id: req.params});
                res.status(200).json({});
                return;
            }else{
                res.status(404).json({msg: "Perfil não encontrado"});
