...
module.exports = {
    ...
    //RAFAEL verifica essa rota se ta funcionando
    followById: async function (req, res, next) {
        ...
        try {
            ...
            if (followObjectId != idToken) {
                ...
                if(profileToken.followersObjectId.find({_id:followObjectId})){
                    profileToken.followersObjectId.pop(followProfile);
                    followProfile.followingObjectId.pop(idToken);
                }else{
                    profileToken.followersObjectId.push(followProfile);
                    followProfile.followingObjectId.psh(idToken);
                }
