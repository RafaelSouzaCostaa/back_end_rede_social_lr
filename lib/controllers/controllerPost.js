...
module.exports = {
    ...
    like: async function (req, res, next) {
        ...
        try {
            ...
            let isEnjoying = true;
            profileLiked.likedPosts.forEach((likedPost) => {
                if (likedPost.postObjectId == req.body.postObjectId) {
                    isEnjoying = false;
                    msg = "Descurtiu";
                    return;
                }
            ...
            if (isEnjoying) {
                ...
                profileLiked.likedPosts = profileLiked.likedPosts.filter(
                    (post) => {
