...
module.exports = {
    ...
    addLike: async function (req, res, next) {
         ...
         */
            //BUG não sei o bug, mas ta crashando o banco quando chama a rota
            //RAFAEL transformar as duas rotas de like em uma só o nome dela pode ser like ou changeLike
            // n sei se fica melhor ou pior, mas tbm da pra passar a id do post pelos parametros da rota, vê o que fica melhor
        ...
        try {
            ...
            let postObjectId = req.body.postObjectId
